...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav mt-2" id="sidebar-nav">
        <!-- <a href="/user-dashboard" class="nav_link {{ request()->is('user-dashboard') ? 'active' : '' }}">
        ...
        <a href="/inovices" class="nav_link {{ request()->is('inovices') ? 'active' : '' }}">
            <iconify-icon icon="iconamoon:invoice-light" class="nav_icon"></iconify-icon>
            <span class="nav_name">Bill/Invoice</span>
        </a>
        <a href="/pay-history" class="nav_link {{ request()->is('pay-history') ? 'active' : '' }}">
