...
@section('content')
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <form action="{{ route('quote.saveBooking') }}" id="quoteForm" method="POST">
                @csrf
                                ...
                                <div class="row form-pad">
                                    <div class="collection_address">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_name"
                                                    value="{{ !empty(Session::get('quote_input')['origin_postal']) && Session::get('quote_input')['origin_postal'] == Auth::user()->postal ? Auth::user()->company_name : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_address_1" id="origin_address_1"
                                                    value="{{ !empty(Session::get('quote_input')['origin_postal']) && Session::get('quote_input')['origin_postal'] == Auth::user()->postal ? Auth::user()->address_1 : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_address_2" id="origin_address_2"
                                                    value="{{ !empty(Session::get('quote_input')['origin_postal']) && Session::get('quote_input')['origin_postal'] == Auth::user()->postal ? Auth::user()->address_2 : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_city" id="origin_city" type="text"
                                                    value="{{ !empty(Session::get('quote_input')['origin_postal']) && Session::get('quote_input')['origin_postal'] == Auth::user()->postal ? Auth::user()->city : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input disabled
                                                    value="{{ !empty(Session::get('quote_input')['origin_country']) ? Session::get('quote_input')['origin_country'] : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input
                                                    value="{{ !empty(Session::get('quote_input')['origin_postal']) ? Session::get('quote_input')['origin_postal'] : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_contact_phone"
                                                    value="{{ Auth::User()->contact_phone_no }}" type="number"
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input name="origin_contact_name" type="text"
                                                    value="{{ Auth::User()->contact_first_name . ' ' . Auth::User()->contact_last_name }}"
                                ...
                                <div class="row form-pad">
                                    <div class="delivery_address">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <input disabled
                                                    value="{{ !empty(Session::get('quote_input')['country']) ? Session::get('quote_input')['country'] : '' }}"
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-12  delivery_postcode">
                                                <input hidden name="postal"
                                                    value="{{ !empty(Session::get('quote_input')['postal']) ? Session::get('quote_input')['postal'] : '' }}"
