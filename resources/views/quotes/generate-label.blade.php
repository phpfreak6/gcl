        ...
        <section class="section dashboard">
            ...
            <div class="booking-info-container top_wrap">
                <div class="booking_wrap">
                    ...
                    <div>{{ $bookingtemp->description }}</div>
                </div>
                <div class="booking_wrap">
                    <label for="email">Email:</label>
                    <div>{{ $bookingtemp->email }}</div>
                </div>

                <!-- <button id="editBtn" type="button" class="btn btn-primary text-white col-lg-3 col-sm-10 ">
                                                                                                                                                                                                                                                                                                                         <a href="{{ route('quote.editBookingView', [
            ...
            <form id="quoteForm" class="px-5">
                ...
                <input type="hidden" name="id" value="{{ $bookingtemp->id }}">
                <input type="hidden" name="description" value="{{ $bookingtemp->description }}">
                <input type="hidden" name="email" value="{{ $bookingtemp->email }}">
                <input type="hidden" name="origin_contact_phone" value="{{ $bookingtemp->origin_phone }}">
                <input type="hidden" name="origin_contact_email" value="{{ $bookingtemp->origin_email }}">
                <input type="hidden" name="origin_contact_name" value="{{ $bookingtemp->origin_contact_name }}">
                <input type="hidden" name="origin_name" value="{{ $bookingtemp->origin_name }}">
                <input type="hidden" name="origin_address_1" value="{{ $bookingtemp->origin_address_1 }}">
                <input type="hidden" name="origin_address_2" value="{{ $bookingtemp->origin_address_2 }}">
                <input type="hidden" name="origin_city" value="{{ $bookingtemp->origin_city }}">
                <input type="hidden" name="origin_postal" value="{{ $bookingtemp->origin_postal }}">
                <input type="hidden" name="origin_country" value="{{ $bookingtemp->origin_country }}">
                <input type="hidden" name="ship_to_phone" value="{{ $bookingtemp->destination_phone }}">
                <input type="hidden" name="ship_to_email" value="{{ $bookingtemp->destination_email }}">
                <input type="hidden" name="ship_to_reference" value="{{ $bookingtemp->destination_contact_name }}">
                <input type="hidden" name="ship_to_name" value="{{ $bookingtemp->destination_name }}">
                <input type="hidden" name="ship_to_address_1" value="{{ $bookingtemp->destination_address_1 }}">
                <input type="hidden" name="ship_to_address_2" value="{{ $bookingtemp->destination_address_2 }}">
                <input type="hidden" name="ship_to_city" value="{{ $bookingtemp->destination_city }}">
                <input type="hidden" name="postal" value="{{ $bookingtemp->destination_postal }}">
                <input type="hidden" name="country" value="{{ $bookingtemp->destination_country }}">
                <input type="hidden" name="collection_note" value="{{ $bookingtemp->collection_note }}">
                <input type="hidden" name="delivery_instructions" value="{{ $bookingtemp->delivery_instructions }}">
            ...
            <select name="payment_gateway" id="payment_gateway">
               ...
               <!-- Add more options as needed -->
                ...
                <div class="col-12 d-flex justify-content-between mt-5">
                    <a href="{{ url()->previous() }}" class="cancel_btn btn btn-secondary text-white col-lg-3 col-sm-10 "
                        style="min-width: 140px !important">Cancel</a>

                    {{-- <button id="generate_label" type="button"
                        class="generate_btn btn btn-primary text-white col-lg-3 col-sm-10 ">Next</button> --}}
                </div>
