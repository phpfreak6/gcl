                    ...
                    <form action="/organization" method="post" id="orgForm" class="px-3 needs-validation" novalidate>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" required
                                class="form-control py-3 {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
                                name="company_name" value="{{ old('company_name') }}" placeholder="@lang('models/users.fields.company_name')">
                        ...
                        <div class="mt-2 form-group">
                            ...
                            <input required type="text"
                                class="form-control py-3 {{ $errors->has('address_1') ? 'is-invalid' : '' }}"
                                name="address_1" value="{{ old('address_1') }}" placeholder="@lang('models/users.fields.address_1')">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 form-group">
                            <label for="Address2" class="form-label" style="font-size:12px; font-weight:bold">Address
                                2</label>
                            <input type="text"
                                class="form-control py-3 {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address_2"
                                value="{{ old('address_2') }}" placeholder="@lang('models/users.fields.address_2')">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 form-group">
                            ...
                            <input type="text" required
                                class="form-control py-3 {{ $errors->has('address') ? 'is-invalid' : '' }}"
                                name="registration_no" value="{{ old('registration_no') }}"
                                placeholder="@lang('models/users.fields.registration_no')">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 d-flex form-group">
                            <div class="col-4">
                                ...
                                <input type="text" required
                                    class="form-control py-3 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city"
                                    value="{{ old('city') }}" placeholder="@lang('models/users.fields.city')">
                            ...
                            <div class="col-7 ms-auto">
                                ...
                                <select required
                                    class="form-control py-3 {{ $errors->has('country') ? 'is-invalid' : '' }}"
                                    name="country">
                        ...
                        <div class="mt-2 d-flex form-group">
                            <div class="col-4">
                                <label for="postal" class="form-label" style="font-size:12px; font-weight:bold">Postal
                                    Code</label>
                                <input type="text" required
                                    class="form-control py-3 {{ $errors->has('postal') ? 'is-invalid' : '' }}"
                                    name="postal" value="{{ old('postal') }}" placeholder="@lang('models/users.fields.postal')">
                                <span class="invalid-feedback">
                            ...
                            <div class="col-7 ms-auto">
                                ...
                                <select required
                                    class="form-control py-3 {{ $errors->has('industry') ? 'is-invalid' : '' }}"
                                    name="industry">
