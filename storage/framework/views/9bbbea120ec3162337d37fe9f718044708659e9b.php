         ...
         <div id="addressFields" class=" my-4 py-5 px-4  form bg-white shadow " style="position: relative; z-index: 1; border-left: 6px solid #309cdc; border-top: 2px solid #309cdc;">
            <div class="panel-body custom-forms splitter checkout_form">
                  ...
                  <div class="col-md-6 col-xs-12 collection_side_r">
                     <div class="row form-pad">
                        <div class="delivery_address">
                           ...
                           <div class="form-group clearfix">
                              <div class="col-xs-12 col-sm-12"><input type="text" autocomplete="228112186off" placeholder="Address Line 3" maxlength="40" class="form-control my-2 py-2 my-2"></div>
                           </div>
                           <div class="form-group clearfix">
                              <div class="col-xs-12 col-sm-12"><input type="text" autocomplete="381641588off" placeholder="City / Town" name="ship_to_city" maxlength="40" class="form-control my-2 py-2 my-2"></div>
                           </div>
                           <div class="form-group clearfix">
                              <label for="collection_postcode" class="control-label col-sm-12 col-xs-12"> Country: </label>
                              <div class="col-xs-12 col-sm-12">
               ...
               <div class="col-12 d-flex justify-content-between mt-5">
                  ...
                  <button id="generate_label" type="button" class="btn btn-primary text-white col-lg-4 col-sm-10 ">Generate Lable</button>
               </div>
               <!-- Generated Label -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Admin Panels\gcl\resources\views/quotes/get-address.blade.php ENDPATH**/ ?>