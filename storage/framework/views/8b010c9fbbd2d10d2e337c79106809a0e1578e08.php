<div class="row d-flex flex-wrap align-items-start">
    <div class="col-md-6 my-3">
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('dcID', null, ['class' => ($errors->has('dcID')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12 py-2">
          <div class="form-group">
             ...
             <?php echo Form::text('first_name', null, ['class' => ($errors->has('first_name')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12 py-2">
          <div class="form-group">
             ...
             <?php echo Form::text('last_name', null, ['class' => ($errors->has('last_name')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
        <div class="form-group">
           ...
           <?php echo Form::text('phone_no', null, ['class' => ($errors->has('phone_no')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12 py-2">
          <div class="form-group">
             ...
             <?php echo Form::email('email', null, ['class' => ($errors->has('email')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
        <div class="form-group">
           ...
           <input type="password" class="form-control <?php echo e($errors->has('password')?'is-invalid py-3':'py-3'); ?>" name="password">
    ...
    <div class="col-md-6 my-3">
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('company_name', null, ['class' => ($errors->has('company_name')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('registration_no', null, ['class' => ($errors->has('registration_no')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('city', null, ['class' => ($errors->has('city')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('postal', null, ['class' => ($errors->has('postal')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <select class="form-control <?php echo e($errors->has('country')?'is-invalid py-3':'py-3'); ?>" name="country">
                ...
                <option value="<?php echo e($country->code); ?>" <?php echo e(isset($user) && $country->code == old('country', $user->country) ? 'selected' : ''); ?>>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('address_1', null, ['class' => ($errors->has('address_1')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          <div class="form-group">
             ...
             <?php echo Form::text('address_2', null, ['class' => ($errors->has('address_2')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="col-md-11 col-12">
          ...
          <select required class="form-control py-3 <?php echo e($errors->has('industry')?'is-invalid':''); ?>" name="industry">
             ...
             <option <?php echo e($user->industry=="Manufacturing"?"selected":""); ?> value="Manufacturing">Manufacturing</option>
             <option <?php echo e($user->industry=="Retail"?"selected":""); ?> value="Retail">Retail</option>
             <option <?php echo e($user->industry=="Hospitality"?"selected":""); ?> value="Hospitality">Hospitality</option>
             <option <?php echo e($user->industry=="Transportation"?"selected":""); ?> value="Transportation">Transportation</option>
    ...
    <div class="col-md-6 my-3">
        ...
        <div class="col-md-11 col-12">
           <div class="form-group">
              ...
              <?php echo Form::text('contact_phone_no', null, ['class' => ($errors->has('contact_phone_no')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
        ...
        <div class="col-md-11 col-12 py-2">
           <div class="form-group">
              ...
              <?php echo Form::text('contact_first_name', null, ['class' => ($errors->has('contact_first_name')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
        ...
        <div class="col-md-11 col-12 py-2">
           <div class="form-group">
              ...
              <?php echo Form::text('contact_last_name', null, ['class' => ($errors->has('contact_last_name')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
        ...
        <div class="col-md-11 col-12 py-2">
           <div class="form-group">
              ...
              <?php echo Form::email('contact_email', null, ['class' => ($errors->has('contact_email')) ? 'form-control is-invalid py-3' : 'form-control py-3'] ); ?>
       ...
       <div class="modal-content">
          ...
          <div class="modal-body d-flex justify-content-between flex-wrap">
             ...
             <div class="form-check col-md-3 col-sm-4 my-2">
               ...
               ?>
               <input class="form-check-input country <?php echo e($index); ?>" name="Favcountries[]" role="button" type="checkbox" value="<?php echo e($country); ?>" <?php echo e($isFavorite ? 'checked' : ''); ?>>
 ...
 </div><?php /**PATH D:\Admin Panels\gcl\resources\views/users/fields.blade.php ENDPATH**/ ?>