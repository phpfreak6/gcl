<style>
    ...
    .notification-icon-bg {
      background-color: rgba(48, 156, 220, 0.3); /* Replace with your desired background color */
      border-radius: 12px; /* Makes it a circle */
      padding: 7px 10px 7px 10px; /* Adjust the padding as needed */
  font-size:30px;
  margin-top:5px;
    }
...
<?php /**PATH D:\Admin Panels\gcl\resources\views/layouts/header.blade.php ENDPATH**/ ?>