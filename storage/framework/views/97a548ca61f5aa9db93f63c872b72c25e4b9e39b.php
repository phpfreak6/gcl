                    ...
                    <form action="/organization" method="post" id="orgForm" class="px-3 needs-validation" novalidate>
                        ...
                        <div class="form-group mt-2">
                            <label for="Company_name" class="form-label"
                                style="font-size:12px; font-weight:bold">Company
                                Name</label>
                            <input type="text" required
                                class="form-control py-3 <?php echo e($errors->has('company_name') ? 'is-invalid' : ''); ?>"
                                name="company_name" value="<?php echo e(old('company_name')); ?>" placeholder="<?php echo app('translator')->get('models/users.fields.company_name'); ?>">
                        ...
                        <div class="mt-2 form-group">
                            <label for="Address1" class="form-label" style="font-size:12px; font-weight:bold">Address
                                1</label>
                            <input required type="text"
                                class="form-control py-3 <?php echo e($errors->has('address_1') ? 'is-invalid' : ''); ?>"
                                name="address_1" value="<?php echo e(old('address_1')); ?>" placeholder="<?php echo app('translator')->get('models/users.fields.address_1'); ?>">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 form-group">
                            <label for="Address2" class="form-label" style="font-size:12px; font-weight:bold">Address
                                2</label>
                            <input type="text"
                                class="form-control py-3 <?php echo e($errors->has('address') ? 'is-invalid' : ''); ?>" name="address_2"
                                value="<?php echo e(old('address_2')); ?>" placeholder="<?php echo app('translator')->get('models/users.fields.address_2'); ?>">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 form-group">
                            ...
                            <input type="text" required
                                class="form-control py-3 <?php echo e($errors->has('address') ? 'is-invalid' : ''); ?>"
                                name="registration_no" value="<?php echo e(old('registration_no')); ?>"
                                placeholder="<?php echo app('translator')->get('models/users.fields.registration_no'); ?>">
                            <span class="invalid-feedback">
                        ...
                        <div class="mt-2 d-flex form-group">
                            <div class="col-4">
                                <label for="city" class="form-label"
                                    style="font-size:12px; font-weight:bold">City</label>
                                <input type="text" required
                                    class="form-control py-3 <?php echo e($errors->has('city') ? 'is-invalid' : ''); ?>" name="city"
                                    value="<?php echo e(old('city')); ?>" placeholder="<?php echo app('translator')->get('models/users.fields.city'); ?>">
                            ...
                            <div class="col-7 ms-auto">
                                ...
                                <select required
                                    class="form-control py-3 <?php echo e($errors->has('country') ? 'is-invalid' : ''); ?>"
                                    name="country">
                                    <option selected disabled>Select country</option>
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($country->code); ?>"><?php echo e($country->name); ?> -
                                            <?php echo e($country->code); ?></option>
                        ...
                        <div class="mt-2 d-flex form-group">
                            <div class="col-4">
                                <label for="postal" class="form-label" style="font-size:12px; font-weight:bold">Postal
                                    Code</label>
                                <input type="text" required
                                    class="form-control py-3 <?php echo e($errors->has('postal') ? 'is-invalid' : ''); ?>"
                                    name="postal" value="<?php echo e(old('postal')); ?>" placeholder="<?php echo app('translator')->get('models/users.fields.postal'); ?>">
                                <span class="invalid-feedback">
                            ...
                            <div class="col-7 ms-auto">
                                ...
                                <select required
                                    class="form-control py-3 <?php echo e($errors->has('industry') ? 'is-invalid' : ''); ?>"
                                    name="industry">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Select Favouriteute Shipping Countries
                    </h5>
...
<?php /**PATH /home/coukshipflow/public_html/devapp.shipflow.co.uk/resources/views/auth/organization.blade.php ENDPATH**/ ?>