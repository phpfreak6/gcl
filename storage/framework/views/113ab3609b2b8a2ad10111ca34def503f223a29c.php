            ...
            <table id="myTable" class="border table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url($booking->uri)); ?>" target="_blank" class="btn btn-primary text-white" type="application/pdf" >Lable</a>
                            <a href="#" class="btn btn-success text-white details-btn" data-details="<?php echo e(json_encode($booking->toArray())); ?>">Details</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\gcl\resources\views/bookings/index.blade.php ENDPATH**/ ?>