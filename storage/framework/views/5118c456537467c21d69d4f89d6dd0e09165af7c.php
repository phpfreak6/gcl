         ...
         <div class="w-100 d-flex justify-content-end mb-2 border-bottom" >
            ...
            <table id="serviceTable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($service->parentCourier->Name ?? 'N/A'); ?></td>
                        <td><?php echo e($service->Name); ?></td>
                        <td><?php echo e($service->service_id); ?></td>
                        <td>
                            <a href="#" class="btn btn-info text-white view-btn" data-toggle="modal" data-target="#viewServiceModal" data-details="<?php echo e(json_encode($service)); ?>">View</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Admin Panels\gcl\resources\views/couriers/service/index.blade.php ENDPATH**/ ?>