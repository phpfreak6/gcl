                     ...
                     <div class="row form-pad">
                        <div class="collection_address">
                           ...
                           <div class="form-group clearfix">
                              ...
                              <div class="col-xs-12 col-sm-12"><input name="origin_contact_phone" value="<?php echo e(Auth::User()->contact_phone_no); ?>" type="number" id="collection_onsite_telephone" placeholder="Onsite Contact Telephone" autocomplete="nope" required="required" maxlength="20" pattern="" class="form-control my-2 py-2 my-2 input_error"></div>
                           </div>
                           <div class="form-group clearfix">
