        ...
        <div class=" my-4 py-5 px-4 form bg-white shadow " style="position: relative; z-index: 1; border-left: 6px solid #309cdc; border-top: 2px solid #309cdc;">
         <div class="row d-flex flex-wrap justify-content-between">
            <div class="col-lg-3 col-md-6 text-center col-12">
               <img src="<?php echo e(asset('/images'.'/' . getImage($selectedQuote['courier']))); ?>"  class="w-50 mb-3" alt="">
         ...
         <div class="row d-flex flex-wrap">
            <div class="col-md-6 col-12">
               ...
               <div class="col-12 d-flex justify-content-between mb-2">
                  <div class="col-6 text-start text-muted">Sub Total</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Admin Panels\gcl\resources\views/quotes/summary.blade.php ENDPATH**/ ?>