<style>
   ...
   .nav_link{display: grid;grid-template-columns: max-content max-content;align-items: center;column-gap: 1rem;padding: .5rem 0 .5rem 1.5rem}
   @import  url("https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap");
   :root{--header-height: 3rem;--nav-width: 268px;--first-color:#FFFFFF;--first-color-light: #000000;--white-color: #309cdc;--body-font: 'Nunito', sans-serif;--normal-font-size: 1rem;--z-fixed: 100}*,::before,::after{box-sizing: border-box}
   .active{color: var(--white-color)}
       ...
       .support-box {
         ...
         .chat-button {
             ...
             border-radius: 10px; /* Rounded corners */
             padding: 3px 3px; /* Add padding to the button */
   ...
   <aside id="sidebar" class="sidebar">
     <div class="sidebar-logo d-flex  justify-content-center">
       ...
       <img src="/images/logo-1.png" class="mb-2" alt="" height ='80'>
...
<?php /**PATH D:\xampp\htdocs\gcl\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>